...
const Search = () => {
  ...
  return (
    <div className='px-{30px] py-6 px-3 max-w-{1170px} mx-auto flex flex-col lg:flex-row justify-between lg:gap-x-3 relative lg:top-4 lg:shadow-1 bg-white rounded'>
    <CountryDropdown/>
    <WhenDropdown/>
    <PriceRangeDropdown/>
    <PropertyDropdown/>
